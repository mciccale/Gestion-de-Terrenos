  ...
  static async addParcela({ terreno_id, ubicacion, hectareas, coordenadas }) {
    try {
      const query = "INSERT INTO parcelas (alquilada, fecha_inicio_alquiler, periodo_arrendamiento, importe_alquiler, dni_arrendatario, ubicacion, hectareas, limites) VALUES ($1,$2,$3,$4,$5,$6,$7, \
        ARRAY[POINT($8,$9),POINT($10,$11),POINT($12,$13),POINT($14,$15)])";
      const params = [false, null, null, null, null, ubicacion, hectareas, coordenadas[0][0],
        coordenadas[0][1], coordenadas[1][0], coordenadas[1][1], coordenadas[2][0], coordenadas[2][1], coordenadas[3][0], coordenadas[3][1]];
